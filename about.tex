...
html {
  ...
  --fig-cap-color:   rgba(0, 0, 0, 0.6);
  /*-- Specify custom fonts ~~~ must be imported above   --*/
  --heading-font:    "Computer Modern Serif", serif;         /* edited */
  --mono-font:       'JetBrains Mono', monospace;     /* edited */
  --body-font:       "Computer Modern Serif", serif;         /* edited */
  --navbar-font:     "Computer Modern Serif", serif;   /* edited */
}
...
.distill-site-header {
  ...
  --text-color:       #000000;                   /* edited */
  --text-size:        20px;                      /* edited */
  --hover-color:      #7c7c7c;                   /* edited */
  --bkgd-color:       rgb(255, 255, 255);          /* edited */
}
...
d-article a {
    border-bottom: 2px solid rgba(56, 59, 241, 0.4);
    text-decoration: none;
}
...
.btn-outline-dark {
    background-color: transparent;
    color: rgb(83, 108, 249);
    border: 1px solid;
    border-color: rgb(83, 108, 249);
}

.btn-outline-dark:hover {
    background-color: rgb(83, 113, 249);
    border-color: rgb(83, 141, 249);
    color: white;
}
...
.icon-link {
    background-color: transparent;
    color: rgb(83, 210, 249);
    border: 1px solid;
    border-color: rgb(83, 94, 249);
...
.icon-link:hover {
    background-color: rgb(83, 169, 249);
    border-color: rgb(99, 83, 249);
    color: white;
}</style>
<style type="text/css">
/* base style */
...
<div class="nav-left">
<a href="index.html" class="title">Qrious</a>
...
\hypertarget{hi-there}{%
\section{Hi there 👋}\label{hi-there}}

\hypertarget{about-me}{%
\subsection{About me ✨}\label{about-me}}

I'm Rahul Chhabra (He/Him) , a citizen of Geekland and a student of
Information Technology at Indian Institute of Information Technology,
Allahabad, batch of 2025.

I'm most comfortable in C++ and Kotlin, followed by Rust.

\hypertarget{currently-working-on}{%
\subsection{Currently Working On 🔭}\label{currently-working-on}}

\hypertarget{nesys}{%
\subsubsection{Nesys}\label{nesys}}

Nesys is an NES emulator I'm writing in Rust. It is a development
exercise. It forces me to write better and more idiomatic Rust (the
codebase will likely be much larger than anything I've dealt with). It's
fun : the 6502 is a fun CPU to study and emulate. It'll be a long
project but I'm also planning to port it to WebAssembly and therefore
run in the ✨ \emph{browser} ✨.
...
\href{https://github.com/anuraghazra/github-readme-stats}{\includegraphics{https://github-readme-stats.vercel.app/api?username=rahulc29\&show_icons=true\&count_private=true}}
...
\href{https://www.linkedin.com/in/rahul-chhabra-452a3317b/}{\includegraphics{https://i.stack.imgur.com/gVE0j.png}
LinkedIn}
